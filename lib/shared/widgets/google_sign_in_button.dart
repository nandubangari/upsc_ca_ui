...
class _GoogleSignInButtonState extends State<GoogleSignInButton> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTapDown: widget.isLoading ? null : (_) => unawaited(_pressController.forward()),
      onTapUp: widget.isLoading ? null : (_) => unawaited(_pressController.reverse()),
      onTapCancel: widget.isLoading ? null : () => unawaited(_pressController.reverse()),
